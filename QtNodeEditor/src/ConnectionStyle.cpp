...
void
ConnectionStyle::setConnectionStyle(QString jsonText)
{
...
void
ConnectionStyle::loadJsonFile(QString styleFile)
{
...
void
ConnectionStyle::loadJsonText(QString jsonText)
{
...
void
ConnectionStyle::loadJsonFromByteArray(QByteArray const & byteArray)
{
...
QColor
ConnectionStyle::constructionColor() const
{
...
QColor
ConnectionStyle::normalColor() const
{
  return NormalColor;
}
...
QColor
ConnectionStyle::normalColor(QString typeId) const
{
...
QColor
ConnectionStyle::selectedColor() const
{
...
QColor
ConnectionStyle::selectedHaloColor() const
{
...
QColor
ConnectionStyle::hoveredColor() const
{
  return HoveredColor;
}
...
float
ConnectionStyle::lineWidth() const
{
  return LineWidth;
}
...
float
ConnectionStyle::constructionLineWidth() const
{
...
float
ConnectionStyle::pointDiameter() const
{
...
bool
ConnectionStyle::useDataDefinedColors() const
{
