...
QRectF
NodeGeometry::entryBoundingRect() const
{
...
void
NodeGeometry::recalculateSize() const
{
...
void
NodeGeometry::recalculateSize(QFont const & font) const
{
...
PortIndex
NodeGeometry::checkHitScenePoint(
  PortType portType,
...
unsigned int
NodeGeometry::validationHeight() const
{
...
unsigned int
NodeGeometry::validationWidth() const
{
  QString msg = _dataModel->validationMessage();
