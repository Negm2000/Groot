...
EditorFlowScene::EditorFlowScene(
...
QtNodes::Node & EditorFlowScene::createNodeAtPos(
  const QString & ID, const QString & instance_name,
  QPointF scene_pos)
{
  ...
  if (!node_model) {
    char buffer[250];
    sprintf(
      buffer, "No registered model with ID: [%s]",
