...
void GrootTestBase::testMouseEvent(
  QGraphicsView * view, QEvent::Type type, QPoint pos, Qt::MouseButton button,
  Qt::KeyboardModifier modifier)
{
  auto event = new QMouseEvent(
    type, pos, view->viewport()->mapToGlobal(pos),
...
void GrootTestBase::testDragObject(
  QGraphicsView * view, const QPoint & screen_pos,
  const QPoint & pos_offset)
{
...
void GrootTestBase::testMessageBox(
  int deplay_ms, TestLocation location,
